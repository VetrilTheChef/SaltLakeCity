...
BEGIN_DEFINE_SPEC(UBBTitleWidgetSpecificationSpec, "SaltLakeCity.Specifications.GUI.TitleWidgetSpecification", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
...
END_DEFINE_SPEC(UBBTitleWidgetSpecificationSpec)

void UBBTitleWidgetSpecificationSpec::Define()
{
