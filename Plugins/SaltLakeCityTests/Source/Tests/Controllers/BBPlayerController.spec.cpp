...
BEGIN_DEFINE_SPEC(UBBPlayerControllerSpec, "SaltLakeCity.Controllers.PlayerController", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
