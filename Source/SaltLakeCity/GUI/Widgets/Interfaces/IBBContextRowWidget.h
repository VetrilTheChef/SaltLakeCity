...
class SALTLAKECITY_API UIBBContextRowWidget : public UIBBWidget
{
	...
	public:
		...
		virtual EBBWidget GetType() const PURE_VIRTUAL(UIBBContextRowWidget::GetType, return EBBWidget::None; );

		virtual void SetRowName(FText NewName) PURE_VIRTUAL(UIBBContextRowWidget::SetRowName, );

		virtual void SetRowIcon(UTexture2D * NewIcon) PURE_VIRTUAL(UIBBContextRowWidget::SetRowIcon, );

		virtual void SetRowTooltip(FText NewTooltip) PURE_VIRTUAL(UIBBContextRowWidget::SetRowTooltip, );
		
		virtual void SetCommand(UIBBCommand * NewCommand) PURE_VIRTUAL(UIBBContextRowWidget::SetCommand, );

		DECLARE_EVENT(UIBBContextRowWidget, FBBOnClick);

		FBBOnClick & OnClicked() { return OnClick; };
