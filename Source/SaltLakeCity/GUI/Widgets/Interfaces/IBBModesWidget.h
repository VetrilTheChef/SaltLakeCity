...
class SALTLAKECITY_API UIBBModesWidget : public UIBBWidget
{
	...
	public:
		...
		virtual EBBWidget GetType() const PURE_VIRTUAL(UIBBModesWidget::GetType, return EBBWidget::None; );

		virtual void SetPlayModeCommand(UIBBCommand * Command) PURE_VIRTUAL(UIBBModesWidget::SetPlayModeCommand, );

		virtual void SetBuildModeCommand(UIBBCommand * Command) PURE_VIRTUAL(UIBBModesWidget::SetBuildModeCommand, );

		virtual void SetActiveMode(EBBGameMode GameMode) PURE_VIRTUAL(UIBBModesWidget::SetActiveMode, );
};