...
BEGIN_DEFINE_SPEC(UBBWorldSettingsSpec, "SaltLakeCity.Levels.WorldSettings.WorldSettings", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
