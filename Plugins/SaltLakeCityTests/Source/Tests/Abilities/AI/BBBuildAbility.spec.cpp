...
BEGIN_DEFINE_SPEC(UBBBuildAbilitySpec, "SaltLakeCity.Abilities.AI.BuildAbility", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
