...
class SALTLAKECITY_API UIBBTitleWidget : public UIBBWidget
{
	...
	public:
		...
		virtual EBBWidget GetType() const override
			PURE_VIRTUAL(UIBBTitleWidget::GetType, return EBBWidget::None; );

		virtual void AddToScreen(int32 ZOrder = 0)
			PURE_VIRTUAL(UIBBTitleWidget::AddToScreen, );

		virtual void SetCloseCommand(UIBBCommand* NewCommand)
			PURE_VIRTUAL(UIBBTitleWidget::SetCloseCommmand, );
