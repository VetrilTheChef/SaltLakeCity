...
BEGIN_DEFINE_SPEC(UBBSelectCommandSpec, "SaltLakeCity.Commands.GameStates.SelectCommand", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
