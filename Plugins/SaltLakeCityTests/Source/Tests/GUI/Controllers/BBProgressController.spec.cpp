...
BEGIN_DEFINE_SPEC(UBBProgressControllerSpec, "SaltLakeCity.GUI.Controllers.Progress", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
