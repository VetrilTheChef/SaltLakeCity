...
BEGIN_DEFINE_SPEC(UBBWorkComponentSpec, "SaltLakeCity.Actors.Components.WorkComponent", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
