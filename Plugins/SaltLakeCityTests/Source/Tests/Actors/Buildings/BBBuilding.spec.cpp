...
BEGIN_DEFINE_SPEC(UBBBuildingSpec, "SaltLakeCity.Actors.Buildings.Building", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
