...
BEGIN_DEFINE_SPEC(UBBSelectionControllerSpec, "SaltLakeCity.GUI.Controllers.Selection", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
