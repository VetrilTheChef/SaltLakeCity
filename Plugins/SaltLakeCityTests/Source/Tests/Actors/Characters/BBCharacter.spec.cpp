...
BEGIN_DEFINE_SPEC(UBBCharacterSpec, "SaltLakeCity.Actors.Characters.Character", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
