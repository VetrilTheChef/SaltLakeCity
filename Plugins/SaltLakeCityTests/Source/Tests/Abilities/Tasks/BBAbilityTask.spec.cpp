...
BEGIN_DEFINE_SPEC(UBBAbilityTaskSpec, "SaltLakeCity.Abilities.Tasks.AbilityTask", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
