...
BEGIN_DEFINE_SPEC(UBBPauseCommandSpec, "SaltLakeCity.Commands.Controllers.PauseCommand", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
