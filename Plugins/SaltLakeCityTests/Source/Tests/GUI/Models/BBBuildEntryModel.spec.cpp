...
BEGIN_DEFINE_SPEC(UBBBuildEntryModelSpec, "SaltLakeCity.GUI.Models.BuildEntry", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
