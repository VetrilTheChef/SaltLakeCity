...
BEGIN_DEFINE_SPEC(UBBDateTimeModelSpec, "SaltLakeCity.GUI.Models.DateTime", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
