...
BEGIN_DEFINE_SPEC(UBBWidgetSpecificationSpec, "SaltLakeCity.Specifications.GUI.WidgetSpecification", EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
...
END_DEFINE_SPEC(UBBWidgetSpecificationSpec)

void UBBWidgetSpecificationSpec::Define()
{
